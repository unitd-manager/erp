...
const MaterialRequestEdit = () => {
  ...
  return (
    <>
      ...
      <Form>
        <FormGroup>
          <ComponentCard title="Material Request Details">
            <Row>
              <Col md="4">
                <FormGroup>
                  <Label>
                  ...
                  <Input type="text" value="MR-1001" name="material_request_code" disabled />
                </FormGroup>
              </Col>
              <Col md="4">
                <FormGroup>
            ...
            <Row>
              <Col md="3">
                <FormGroup>
                  ...
                  <Input type="text" value="14-07-2023" name="material_request_date" />
                </FormGroup>
              </Col>
              <Col md="3">
                <FormGroup>
